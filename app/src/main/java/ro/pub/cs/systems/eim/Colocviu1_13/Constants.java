...
public interface Constants {
    final public static String CARDINALS_COUNT = "cardinalsCount";
    final public static String CARDINALS_TEXT = "cardinalsText";
    ...
    final public static String ACTION_TYPE = "display.sum";
